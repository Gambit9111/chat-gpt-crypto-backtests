...
#sl 0.02
#sma 27
#outperforms the market on ethusdt, sol, daily with a smalldrowdown
...
params = {
    'stop_loss_percent': [0.02],  # Example: 0.02 (2%)
    'sma_period': [27],  # Example: 27
}

# params = {
#     'stop_loss_percent': [i / 100 for i in range(1, 5, 1)],
